({
    ...
    getAwardedProjects : function(component, event, helper) {
        console.log('getAwardedProjects ');
        ...
        if(userId!=null){
            ...
            var action = component.get('c.getAwardedProjList');
            action.setParams({
                "uId" : userId
            });
            ...
            action.setCallback(this,function(response){
                ...
                if (state === "SUCCESS") {
                    var projectList = response.getReturnValue();
                    if(projectList!=null){
                        component.set("v.ProjectList_Awarded",projectList);
                        console.log("Success - Projects Found");
                        console.log("projectList - "+projectList);
                    }
                    else{
