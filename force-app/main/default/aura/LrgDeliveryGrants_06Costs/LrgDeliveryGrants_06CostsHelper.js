({
    ...
    actualDelCosts : function(component,rid) {
        console.log("delCosts");
        console.log("rid - "+rid);
        var action = component.get("c.getActualDelCosts");
        action.setParams({
            "projId" : rid
        });
        action.setCallback(this, function(response){
    ...
    actualDelIncome : function(component, rid) {
        console.log("devIncome");
        console.log("rid - "+rid);
        var action = component.get("c.getActualDelIncome");
        action.setParams({
            "projId" : rid
        });
        action.setCallback(this, function(response){
